...
class DataDisplay2(DisplayBase):
    def __init__(self):
        self.nodes = []
        self.links = []
        self.row_chars = 30
    ...
    def get_graph_script(self):
        return pkg_resources.resource_string(__name__, 'complex_graph.js')
    ...
    def is_searched(self, node, search_nodes):
